...
class HybridBottleneckParameters(
    ConvolutionParameters, TransformerParameters, typing.Protocol
):
    '''Typed container for hybrid bottleneck configuration.'''
    @property
    def num_conv_blocks(self) -> int: ...
    @property
    def num_transformer_blocks(self) -> int: ...
...
class BottleneckConfig(typing.Protocol):
    ...
    @property
    def hybrid_params(self) -> HybridBottleneckParameters | None: ...

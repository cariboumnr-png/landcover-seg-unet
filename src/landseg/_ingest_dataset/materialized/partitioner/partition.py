...
import numpy
# local imports
import landseg._ingest_dataset.materialized.partitioner as partioner
...
def partition_blocks(
    ...
    *,
    ...
    splits = partioner.stratified_splitter(
        base_count,
    ...
    ranked_candidates = partioner.score_blocks(
        global_class_count,
        blocks_to_score,
    ...
    selected, current_count = partioner.hydrate_train_split(
        train_class_count,
        ranked_candidates,
